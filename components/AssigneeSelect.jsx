...
export default function AssigneeSelect({ value, onChange, avatarOnly }) {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      {open && (
        <div style={{ position: 'absolute', top: '100%', left: 0, zIndex: 999, background: '#fff', border: '1px solid #dfe1e6', borderRadius: 4, boxShadow: '0 4px 16px rgba(0,0,0,0.15)', minWidth: 160, marginTop: 2 }}>
